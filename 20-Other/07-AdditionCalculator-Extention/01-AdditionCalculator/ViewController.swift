...
class ViewController: UIViewController {
    ...
    func setupAddition() {
        ...
        let textFiled1 = UITextField(frame: CGRect(x: 20, y: 30, width: 100, height: 30), placeholder: "0", fontSize: 14.0)
        textFiled1.text = ""
        ...
        let textFiled2 = UITextField(frame: CGRect(x: CGRectGetMaxX(additionLabel.frame) + 10, y: 30, width: 100, height: 30), placeholder: "0", fontSize: 14.0)
        textFiled2.text = ""
